//const n = Number.parseInt(prompt("Введите первое число"));
//const m = +prompt("Введите второе число");
//alert(`Результат сложения числа ${n} и ${m} равен: ${n + m}`);
...
// const n = Number.parseInt(prompt("Введите первое число"));
// const m = Number.parseInt(prompt("Введите второе число"));

// function sum(a, b) {
//     return a + b;
// }

// alert(`Результат сложения числа ${n} и ${m} равен: ${sum(n, m)}`);


// Ctrl + слэш рядом с точкой - комментарий
// 2.
...
// const request = confirm('Вам хорошо живется?')
