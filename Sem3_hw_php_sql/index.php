...
$workexp = [
    [
        ...
        'date_start' => 'Jan 2022',
        'date_end' => 'Current',
        'description' => 'Work in Google',
    ],
    [
        'work_title' => 'Amazon',
        'date_start' => 'Jan 2020',
        'date_end' => 'Jan 2022',
        'description' => 'Work in Amazon',   
    ],
    [
        'work_title' => 'Yandex',
        'date_start' => 'Jan 2016',
        'date_end' => 'Jan 2020',
        'description' => 'Work in Yandex',       
    ],
    ];
?>
<!DOCTYPE html>
    ...
    <div class="w3-row-padding">
      ...
      <div class="w3-twothird">
        <div class="w3-container w3-card w3-white w3-margin-bottom">
          ...
          <?php for ($i = 0; $i < 1; $i++):?>
              <div class="w3-container">
                <h5 class="w3-opacity"><b><?php echo $workexp[$i]['work_title'];?></b></h5>
                <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $workexp[$i]['date_start'];?> - <span
                    class="w3-tag w3-teal w3-round"><?php echo $workexp[$i]['date_end'];?></span></h6>
                <p><?php echo $workexp[$i]['description'];?></p>
                <hr>
              </div>
          <?php endfor;?>
          <?php for ($i = 1; $i < count($workexp); $i++):?>
              <div class="w3-container">
                <h5 class="w3-opacity"><b><?php echo $workexp[$i]['work_title'];?></b></h5>
                <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $workexp[$i]['date_start'];?> - <?php echo $workexp[$i]['date_end'];?></h6>
                <p><?php echo $workexp[$i]['description'];?></p>
                <hr>
              </div>
          <?php endfor;?>
